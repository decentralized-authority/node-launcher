...
export class Dash extends Bitcoin {
  ...
  constructor(data: CryptoNodeData, docker?: Docker) {
    ...
    this.version = data.version || Dash.versions(this.client, this.network)[0].version;
    this.dockerImage = data.dockerImage || Dash.versions(this.client, this.network)[0].image;
    if(docker)
      this._docker = docker;
  }
